...
const evidence={schemaVersion:'NODE8_ORACLE_HOST_PREFLIGHT_V1',result,observedAt:new Date().toISOString(),releaseImage:image||null,minimumDiskGiB:Number(minDisk),checks,oracleCliRequired:false,providerIndependent:true,containsSecrets:false};
